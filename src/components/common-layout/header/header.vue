...
<style scoped>
/* 自定义 Menu 中 item 指针悬浮时样式 */
.header /deep/ .el-menu--horizontal > .el-menu-item:hover {
    background-color: #F8F9FA;
}

/* 自定义 Menu 中最后一个 Profile 或 GetStarted 按钮指针悬浮样式 */
.header /deep/ .el-menu--horizontal > .el-menu-item.header-menu-get-started:hover {
    background-color: transparent;
}

.header /deep/ .el-menu--horizontal > .el-menu-item.header-menu-profile:hover {
    background-color: transparent;
}

/* 自定义 Menu 中最后一个 Profile 或 GetStarted 选中时样式 */
.header /deep/ .el-menu--horizontal > .el-menu-item.header-menu-get-started.is-active {
    background-color: transparent;
}
...
.header /deep/ .el-menu-item .header-profile .el-dropdown:hover {
    background-color: transparent;
